...
/// The callback used by [QuickReorderableListView] to move an item to a new
/// position in a list.
///
...
/// [QuickReorderableListView] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class QuickReorderableListView extends StatefulWidget {

  /// Creates a reorderable list.
  QuickReorderableListView({
    Key key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [QuickReorderableListView] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _QuickReorderableListViewState createState() => _QuickReorderableListViewState();
}
...
class _QuickReorderableListViewState extends State<QuickReorderableListView> {
  // We use an inner overlay so that the dragging list item doesn't draw outside of the list itself.
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$QuickReorderableListView overlay key');
